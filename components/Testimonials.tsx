...
export default function Testimonials() {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-neutral-200">
      ...
      {/* Grid with 3D Perspective Tilt */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {testimonials.map((item, idx) => (
          <Card3DTilt key={idx}>
            <div className="p-8 h-full rounded-3xl bg-neutral-50 border border-neutral-200 hover:border-blue-300 transition-all duration-300 flex flex-col justify-between shadow-sm">
              <div>
